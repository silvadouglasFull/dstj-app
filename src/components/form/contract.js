...
const Contract = () => {
    return <div tabIndex="-1" style={{ display: 'block' }}><p></p>
        ...
        <p>Este documento, e todo o conteúdo do site é oferecido por  DS TJ <i className="fas fa-laptop-code"></i> o endereço https://djts.eshopee.com.br, neste termo representado apenas por "EMPRESA", que regulamenta todos os direitos e obrigações com todos que acessam o site, denominado neste termo como "VISITANTE", reguardado todos os direitos previstos na legislação, trazem as cláusulas abaixo como requisito para acesso e visita do mesmo.</p>
        <p>
        ...
        <p>A EMPRESA pode alugar ou vender espaços publicitários na plataforma, ou no site, diretamente aos anunciantes, ou através de empresas especializadas com o Adsense (Google), Taboola, ou outras plataformas de publicidade.</p>
        <p>

        </p>
        <p>Essas publicidades não significam nenhuma forma endosso ou responsabilidade pelos mesmos, ficando o VISITANTE responsável pelas compras, visitas, acessos ou quaisquer ações referentes as estas empresas.</p>
        <p>
        ...
        <p>Apesar da EMPRESA apenas criar links para sites externos de extrema confiança, caso o usuário acesse um site externo, a EMPRESA não tem nenhuma responsabilidade pelo meio, sendo uma mera indicação de complementação de conteúdo, ficando o mesmo responsável pelo acesso, assim como sobre quaisquer ações que realizem neste site.</p>
        <p>Este documento, chamado "Termos de Uso", aplicáveis a todos os visitantes do site, e desenvolvido pelo Advogado <a href="https://diegocastro.adv.br/modelo-de-termos-de-uso-para-blogs-e-sites/" rel="”nofollow”">Diego Castro (OAB/PI 15.613</a>), foi modificado com permissão para este site.</p>
        <p>
